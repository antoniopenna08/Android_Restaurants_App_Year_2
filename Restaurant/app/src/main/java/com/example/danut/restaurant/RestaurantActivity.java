...
public class RestaurantActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonNewRestaurant.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Context context = RestaurantActivity.this;
                        ...
                        .setPositiveButton("OK",
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog,int id) {
                                        if(TextUtils.isEmpty(rest_name.getText().toString())){
    ...
    public void createRestaurant(final String restName, String restAddress){
        ...
        if(!restaurantExist){
            Restaurants re = new Restaurants(restName, restAddress, currentUser.getUid());
            ...
            Toast.makeText(RestaurantActivity.this, "Restaurant exist!", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void RestaurantDetails(){
        finish();
        //startActivity(new Intent(ImageActivity.this, UserPage.class));
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.logOutRestaurant:{
                LogOutRestaurant();
            }
        }

        switch (item.getItemId()){
            case R.id.restDetails:{
                RestaurantDetails();
            }
        }
